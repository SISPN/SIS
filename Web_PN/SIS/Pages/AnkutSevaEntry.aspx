<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="AnkutSevaEntry.aspx.cs"
    Inherits="SIS.Pages.AnkutSevaEntry" MasterPageFile="~/Site.Master" EnableEventValidation="false" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:Label ID="lblaltemail2" runat="server" Text="Sent Padharamni Done?"></asp:Label>
                    </td>
                    <td>
                        <asp:CheckBox ID="chksant" runat="server" Text="Yes" OnCheckedChanged="chksant_CheckedChanged" />
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="textbox_adjust" colspan="2">
                <asp:DropDownList ID="ddlname" runat="server" Width="245px">
                </asp:DropDownList>
                <ajaxToolkit:CascadingDropDown ID="CascadingDropDown1" runat="server" Category="Name" LoadingText="Please wait ..." ParentControlID="ddlMandal" ServiceMethod="GetNameFromMandal" ServicePath="~/WebServices/XetraMandal.asmx" TargetControlID="ddlname">
                </ajaxToolkit:CascadingDropDown>
                <asp:LinkButton ID="lnkgetId0" runat="server" OnClick="lnkgetId0_Click">Get Person Id</asp:LinkButton>
