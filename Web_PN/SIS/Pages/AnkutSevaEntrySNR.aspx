<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="AnkutSevaEntrySNR.aspx.cs"
    Inherits="SIS.Pages.AnkutSevaEntrySNR" MasterPageFile="~/Site.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="textbox_adjust" colspan="2">
                <asp:DropDownList ID="ddlak" runat="server" AutoCompleteMode="SuggestAppend" AutoPostBack="true" CaseSensitive="False" CssClass="WindowsStyle" DropDownStyle="DropDownList"  Width="245px" OnSelectedIndexChanged="ddlak_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="Ankut Sevak"></asp:Label>
            </td>
            <td class="textbox_adjust" colspan="2">
