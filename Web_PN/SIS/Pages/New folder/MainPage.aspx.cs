...
using CIS.Entity;
using CIS.Utility;
using CIS.Entity.Xetra;
using CIS.Entity.GeographyDDMenu;
using AjaxControlToolkit;
using System.IO;
using CIS.HelperClass;
...
namespace CIS.Pages
{
    public partial class MainPage : System.Web.UI.Page
    {
        ...
        private void GetPCountry()
        {
            ...
            cmbPCountry.DataValueField = "CountryId";
        ...
        private void GetOCountry()
        {
            ...
            cmbOCountry.DataValueField = "CountryId";
        ...
        private void GetStateList()
        {
            ...
            DropDownList2.DataSource = StateList;
        ...
        private void GetOStateList()
        {
            ...
            cmbOstate.DataValueField = "StateId";
            cmbOstate.DataBind();
        ...
        private void GetDistrictList()
        {
            ...
            DropDownList3.DataSource = DistrictList;
        ...
        private void GetODistrictList()
        {
            ...
            cmbODistrict.DataValueField = "DistrictId";
        ...
        private void GetPCityList()
        {
            ...
            cmbPCity.DataValueField = "CityId";
            cmbPCity.DataBind();
        }
        ...
        private void GetOCityList()
        {
            ...
            cmbOCity.DataValueField = "CityId";
            cmbOCity.DataBind();
        }
