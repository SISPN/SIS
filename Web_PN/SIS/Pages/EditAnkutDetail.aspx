<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAnkutDetail.aspx.cs" Inherits="SIS.Pages.EditAnkutDetail"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <tr>
            <td colspan="3">
                <asp:ListView ID="dlresultlist" runat="server" ItemPlaceholderID="itemPlaceHolderId" OnItemCommand="dlresultlist_ItemCommand" OnItemDeleting="dlresultlist_ItemDeleting">
                    <LayoutTemplate>
                        <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #000; border-top: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000;">
                            <tr class="Grid_Header">
                                <td style="width: 10%; padding-left: 5px;">
                                    <asp:Label ID="lblStudentid" runat="server" Text="A Id" CssClass="normal_link_header_bold"></asp:Label>
                                </td>
                                ...
                                <td style="width: 15%;">
                                    ...
                                    <td style="width: 25%;">
                                    <asp:Label ID="Label8" runat="server" Text="Seva Bring Name" CssClass="normal_link_header_bold"></asp:Label>
                                </td>
                                  <td style="width: 5%; padding-left: 5px;">
                                    <asp:Label ID="Label2" runat="server" Text="Seva Bring Xetra" CssClass="normal_link_header_bold"></asp:Label>
                                </td>
                                  <td style="width: 5%; padding-left: 5px;">
                                    <asp:Label ID="Label5" runat="server" Text="Seva Bring Mandal" CssClass="normal_link_header_bold"></asp:Label>
                                </td>
                                     <td style="width: 5%; padding-left: 5px;">
                                    <asp:Label ID="Label6" runat="server" Text="Seva Bring DId" CssClass="normal_link_header_bold"></asp:Label>
                                </td>
                                <td style="width: 5%;">
                                 ...
                                 <td style="width: 5%;">
                                    <asp:Label ID="lbldelete" runat="server" Text="Delete" CssClass="normal_link_header_bold"></asp:Label>
                                </td>
                    ...
                    <ItemTemplate>
                        <tr class='<%# Container.DisplayIndex % 2 == 0 ? "RowStyle": "AlterRowStyle"%>' style="height: 25px;">
                            ...
                            <td class="normalText">
                               ...
                               <td class="normalText">
                                <asp:Label ID="Label7" runat="server" Text='<%# Eval("BringFullName") %>'></asp:Label>
                            </td>

                              <td class="normalText">
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Xetra") %>'></asp:Label>
                            </td>
                                 <td class="normalText">
                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("Mandal") %>'></asp:Label>
                            </td>
                                    <td class="normalText">
                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("DId") %>'></asp:Label>
                            </td>
                            <td class="normalText">
                                <asp:HyperLink ID="hlnkedit" runat="server" Text="Edit" NavigateUrl=' <%#  "~/Pages/AnkutSevaEntry.aspx?AUId=" + Eval("ID") %>'></asp:HyperLink>
                            </td>
                                 <td class="normalText">
                                <asp:LinkButton ID="hlnkdelete" runat="server" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("ID") %>'></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
