<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="MainPerson.aspx.cs"
    Inherits="SIS.Pages.MainPerson" MasterPageFile="~/Site.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="btnsaveandenterother" class="btn btn-medium btn-primary" runat="server" Text="Save & Add Family Member"
