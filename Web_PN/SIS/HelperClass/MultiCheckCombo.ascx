<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiCheckCombo.ascx.cs" Inherits="SIS.HelperClass.MultiCheckCombo" %>
...
function CheckItem(checkBoxList)
{
  ...
  //  var arrayOfCheckBoxLabels = checkBoxList.getElementsByTagName("label");
   // var arrayOfCheckBoxLabels = checkBoxList.getElementsByTagName("span");
    var s = "";
